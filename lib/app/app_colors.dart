...
class AppColors {
  ...
  static const appCream = Color(0xFFF6F1EA);
  static const white = Color(0xFFFFFFFF);
  static const surfaceWhite = Color(0xFFFBFCFF);
  static const fieldSurface = Color(0xFFF8FAFF);
  static const softPanel = Color(0xFFF6F8FE);
  static const softBlue = Color(0xFFF1F5FF);
  static const softBlueAlt = Color(0xFFF2F6FF);
  static const softBlueTint = Color(0xFFEAF1FF);
  static const textOnHero = Color(0xFFF1F7FF);

  static const borderBlue = Color(0xFFB9C9F7);
  static const borderBlueLight = Color(0xFFD2DFFF);
  static const borderBlueSoft = Color(0xFFD9E5F8);
  static const borderBluePale = Color(0xFFDDE7FF);
  static const borderNeutral = Color(0xFFD5DCEB);
  static const disabledBlue = Color(0xFFD7DDEE);
  static const chartTrackBlue = Color(0xFFB8CCE9);

  static const textNavy = Color(0xFF1A2850);
  ...
  static const warningSurface = Color(0xFFFFF1D9);
  static const dangerRed = Color(0xFFB33535);
